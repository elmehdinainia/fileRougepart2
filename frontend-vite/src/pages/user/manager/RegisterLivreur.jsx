...
const baseURL = 'http://localhost:5500/api/user'
  ...
  return (
    <div>
      <section className="bg-gray-50" >
        <div  className="flex flex-col items-center  px-6 mx-auto  lg:py-10">
          <div className=" bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700" style={{ backgroundColor: '#111827' }}>
            <div className="p-6  space-y-3 md:space-y-9 sm:p-8">
