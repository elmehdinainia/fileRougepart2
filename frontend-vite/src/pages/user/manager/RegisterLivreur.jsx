...
//   Axios.post(`${baseURL}/manager/registerlivreur`, user)
//   .then(res => {
            ...
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form onSubmit={onSubmit} className="space-y-4 md:space-y-6">
                <div>
                  ...
                  <Input type="text"  class="bg-gray-50 border text-black border-gray-300  sm:text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" id="first_name" name="first_name" placeholder="First Name" />
                </div>
                <div>
                  <Label htmlFor="last_name" class="block mb-2 text-sm font-medium text-white dark:text-white" label="Last Name" />
                  <Input type="text"  class="bg-gray-50 border border-gray-300 text-black sm:text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" id="last_name" name="last_name" placeholder="Last Name" />
                </div>
                <div>
                ...
                <div>
                  <Label htmlFor="address" class="block mb-2 text-sm font-medium text-white dark:text-white" label="address" />
                ...
                <div className="flex justify-around">
                  <div className="">
                    ...
                    <Input type="password"  class="bg-gray-50 border border-gray-300 text-black sm:text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" id="password" name="password" placeholder="*********" />
                  </div>
                  <div>
